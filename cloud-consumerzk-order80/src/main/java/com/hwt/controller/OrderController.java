...
public class OrderController {
    //单机
    private static final String PAYMENT_URL = "http://172.16.9.74:8004";
    //集群
    ...
    @PostMapping("/getZookeeper")
    public String getZookeeper(){
        return restTemplate.postForObject(PAYMENT_URL + "/payment/zookeeper", new Payment(), String.class);
    }
}
